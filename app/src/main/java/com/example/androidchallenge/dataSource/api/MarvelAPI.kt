...
interface MarvelAPI {
    ...
    suspend fun getHeroes(@QueryMap auth: HashMap<String, String>,
                          @Query("limit") limit: Int): Response<HeroesResponse>

    @GET("characters/{characterId}/comics")
    suspend fun getComics(@Path("characterId") characterId: Int,
                          @QueryMap auth: HashMap<String, String>): Response<ComicsResponse>
}